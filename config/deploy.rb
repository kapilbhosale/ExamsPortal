...
set :domain, 'exams.smartclassapp.in'
set :deploy_to, '/home/ubuntu/app'
set :repository, 'git@github.com:akshaymohite/SmartExamsRails.git'
set :branch, 'offline-support'
...
task :setup do
  command %{rvm install 2.5.1 --skip-existing}
end
